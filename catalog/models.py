...
# Модель Author должна быть определена до модели Book, которая на нее ссылается
...
# Модель Genre должна быть определена до модели Book, которая на нее ссылается
...
class Book(models.Model):
    ...
    # Теперь используется корректный класс модели Genre
